...
public class ChessGameLogic {
	...
	private boolean isOneKingStalemate(ChessBoard chessBoard, ChessPiece king, int type)
	{
		int nbPiece = 0;
	...
	public boolean isStalemate(ChessBoard chessBoard, ChessPiece king, int type)
	{
	...
	public boolean isCheckmate(ChessBoard chessboard, int xPos, int yPos, int type)
	{
		...
		{
			ChessPiece checkPiece = chessboard.checkPieces.get(0);
			canCapture(chessboard, checkPiece);
			canProtect(chessboard, xPos, yPos, type, checkPiece);
			if (!chessboard.saviorPieces.isEmpty())
			{
				for(Iterator<ChessPiece> chessPiece = chessboard.saviorPieces.iterator(); chessPiece.hasNext(); )
				{
	...
	public void canCapture(ChessBoard chessboard, ChessPiece checkPiece)
	{
	...
	public void canProtect(ChessBoard chessboard, int xPos, int yPos, int type, ChessPiece checkPiece)
	{
