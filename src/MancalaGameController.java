 ...
 * 
 * This class handles the user clicks and updates the game after every turn
 */
public class MancalaGameController implements Initializable 
{
	...
	//checks if there are any possible moves for the active player
	public boolean done()
	{
		if(player1.isActive())
		{
	...
	//indicates a winner or tie if the game is over. If the game is not over, it switches the player's turn
